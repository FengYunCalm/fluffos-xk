...
#define __RC_MULTICORE_MODE__ CFG_INT(69)

#define __RECOMPILE_OBJECT_ENABLED__ CFG_INT(70)
#define __RECOMPILE_OBJECT_QUIESCE_TIMEOUT_MS__ CFG_INT(71)
#define __RC_MAX_SUSPENDED_ASYNC__ CFG_INT(72)
#define __RC_ASYNC_DRAIN_EVAL_BUDGET__ CFG_INT(73)
#define __RC_MAX_PENDING_DELIVERIES__ CFG_INT(74)
#define __RC_DISPLAY_PRELOAD_PROGRESS__ CFG_INT(75)
